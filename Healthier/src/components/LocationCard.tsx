...
interface LocationCardProps {
  ...
  isWantToTry: boolean;
  onToggleWantToTry: (id: number) => void;
}
...
export default function LocationCard({
  location, onClose, onNavigate, userLocation, isFavorite, onToggleFavorite, isWantToTry, onToggleWantToTry,
}: LocationCardProps) {
  ...
  const dist = userLocation ? getDistance(userLocation.lat, userLocation.lng, location.lat, location.lng) : null;
    ...
    <div className="location-card" role="dialog" aria-label={location.name}>
      ...
      <div className="card-content">
        ...
        <div className="card-actions">
          ...
          <button className={`wtt-btn ${isWantToTry ? "wtt-active" : ""}`} onClick={() => onToggleWantToTry(location.id)} aria-label={isWantToTry ? "Remove from Want to Try" : "Want to try"}>
            📋
          </button>
